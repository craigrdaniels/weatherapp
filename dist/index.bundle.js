...
var loadWeatherIcon = function loadWeatherIcon(data) {
  ...
  console.warn((0,_loadIcon__WEBPACK_IMPORTED_MODULE_0__["default"])(data.current.weather[0].icon));
  weatherIcon.innerHTML = rendered;
  document.getElementById('weatherIcon').parentElement.parentElement.parentElement.classList.remove(['animate-pulse']);
...
var createDetailsChild = function createDetailsChild(id) {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', id, ['flex', 'flex-col', 'justify-evenly', 'items-center', 'text-2xl', 'md:text-3xl', 'w-1/4', 'h-full', 'rounded-md', 'bg-gray-300'], null);
  return element;
};

var displayDetails = function displayDetails() {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'details', ['flex', 'justify-start', 'self-center', 'bg-gray-100', 'dark:bg-gray-700', 'gap-2', 'w-80', 'h-20', 'md:h-28', 'rounded-md'], null);
...
var displayDetailsContainer = function displayDetailsContainer() {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', null, ['flex', 'flex-col', 'place-content-center', 'w-full', 'gap-6'], null);
  element.appendChild(displayDetails());
  element.appendChild(displayForecastContainer());
  return element;
};

var displayBreak = function displayBreak() {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', null, ['flex', 'hidden', 'md:block', 'md:w-px', 'bg-gray-300', 'self-stretch'], null);
  return element;
};
...
var displaySearchContainer = function displaySearchContainer() {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', null, ['flex', 'flex-col', 'justify-center', 'self-start', 'items-center', 'w-full'], null);
...
var displayWeatherIcon = function displayWeatherIcon() {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', 'weatherIcon', ['flex', 'self-center', 'w-36', 'h-36', 'rounded-md', 'bg-gray-300'], null);
  return element;
};

var mainWeatherContainer = function mainWeatherContainer() {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', null, ['flex', 'flex-col', 'place-content-center', 'w-full', 'gap-6'], null);
...
var contentContainer = function contentContainer() {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', null, ['flex', 'flex-col', 'md:flex-row', 'place-content-center', 'w-full', 'gap-6'], null);
...
var displayWeatherCard = function displayWeatherCard(searchCity) {
  var element = (0,_modules_handlers_createHtmlElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div', null, ['animate-pulse', 'flex', 'flex-col', 'p-4', 'pt-8', 'mx-auto', 'gap-6', 'md:border', 'md:shadow-xl', 'md:rounded-lg', 'md:max-h-sm', 'self-center'], null);
